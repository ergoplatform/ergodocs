...
1. We already have crowdfunding on the Ergo blockchain via [ErgoRaffle](ergoraffle.md); this allows projects to host *'Raffles'* with a prize percentage allocated to the lucky donor.
