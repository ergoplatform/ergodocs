...
- [How it works](token-transfer-flows.md)
- [Fees and dust](fees-and-dust.md)
- [Security posture](security-model.md)
- [Watcher setup/troubleshooting](watcher.md)
- [Team/Operations FAQ](rosen-faq.md)
...
- Watcher operators: see [watcher setup and FAQ](watcher.md) for logs, volumes, health, `minBoxValue`, and architecture-specific issues.
