...
Browse ecosystem project pages. Sidebar keeps active/current projects; this table keeps the long tail discoverable. `Active` means verified Git activity in the last six months, using 2025-11-29 as the cutoff for this 2026-05-29 sweep. Some live infrastructure or closed-source sites are marked separately.
...
| Project | Live site | Status | Last Git activity |
| --- | --- | --- | --- |
| [Bene](bene.md) | - | Active | 2026-05-29 |
...
| [GitCircles](gitcircles.md) | Recent, not active | 2025-10-18 |
