...
- `Jun 25` to `Jul 4`: the app fixed finalized-game prize pool and commission display, derived finalized prize pools from history when needed, and added a single-click circular theme toggle.
