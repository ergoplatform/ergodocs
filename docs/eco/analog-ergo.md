...
The current ScalaSigmaParticle example also demonstrates extending the scalar-lock idea into a two-party atomic-swap multisig contract, using group-element locks as the cross-chain coordination primitive.
