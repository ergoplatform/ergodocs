...
Ecosystem is the discovery layer for Ergo projects and initiatives. Browse applications, infrastructure, organizations, tools, directories, and project profiles without turning the sidebar into a full directory.
...
| [Privacy](privacy/index.md) | Privacy-focused tools and related user documentation. |
| [NFTs & Games](nfts-and-games/index.md) | NFT marketplaces, games, and collectible projects. |
| [Tools & Data](tools-and-data/index.md) | Utility apps, data tools, knowledge bases, media projects, and user-facing support tooling. |
