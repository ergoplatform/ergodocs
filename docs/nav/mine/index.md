...
Mine is for miners and mining-pool operators. Mining setup, pool operation, miner governance, tooling, and mining resources.
...
| --- | --- |
| [Getting Started](getting-started/index.md) | Mining onboarding, software, pools, and setup paths. |
| [Pool Operations](pool-operations/index.md) | Pool hosting, Stratum, and MiningCore operations. |
