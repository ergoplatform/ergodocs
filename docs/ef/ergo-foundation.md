...
The Ergo Foundation is the legal and treasury entity created to bootstrap Ergo's early ecosystem. Its role has changed over time: the Foundation no longer operates as a large independent funding source, but it still provides governance continuity, transparency, and a legal wrapper for community-led initiatives that need a formal counterparty.

Use these pages for the main Foundation records:

- [Treasury](ef-treasury.md): current holdings, treasury withdrawals, spending breakdowns, and salary summaries.
...
The Ergo Foundation is composed of members who primarily function as multi-signature custodians and governance participants. Historically, they voted on proposals to allocate treasury funds in alignment with the Foundation's mission. Today, with liquid treasury funds limited, the Foundation's role is increasingly focused on continuity, accounting, signatory services, and handover to community-led groups.

Foundation members have historically handled organisational work such as exchange and market-maker discussions, internal accounting, budgeting, and third-party coordination. This has included:
...
- **Role & Responsibilities:** His role in the foundation is related to business development, and he co-founded Rosen with mhs_sam.
...
The Ergo ecosystem is made up of salaried contributors, volunteers, bounty collectors, and independent project developers. There is no single designated "core" development team. Contributors who make significant additions to core repositories may be invited to core development discussions regardless of employment status.

### DevDAO

**Alexander Chepurnoy (kushti)** has been active in the blockchain field since 2011. He has authored over twenty academic papers and has more than fifteen years of experience in software development. Prior to co-founding Ergo, he co-founded smartcontract.com (now Chainlink), served as a core developer at NXT, and was one of the first employees at IOHK, where he held the positions of Research Fellow and Team Scorex Manager. He manages any bounties relating to the reference client repository and keeps a watch over [sigma-rust](sigma-rust.md) development and any other high-level development and research not covered otherwise.

- **Role & Responsibilities:** Alex stepped back from the Foundation in January 2024 to focus solely on development; see his announcement post [here](https://www.ergoforum.org/t/core-developer-kushti-is-leaving-ergo-foundation/4648). He helped move development coordination toward DevDAO and continues to manage communications between developers and EF where needed.

#### Outgoings

Historical Foundation outgoings included member compensation, marketing/editorial work, development salaries, bounties, exchange and market-maker costs, infrastructure, events, grants, and legal or operational expenses. Current and historical figures are maintained in the Treasury page.
