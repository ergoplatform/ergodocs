...
Click any of the event names below to jump directly to an overview and related resources. 
...
- [**DumDumDum**](#dumdumdum) is a decentralised Twitter alternative stored **on-chain** using NFTs.
- [**Cyti**](#cyti) mineable smart contracts
...
- [**Obolflip**](#obolflip) is a decentralised CoinFlip game (head/tail).
- [**ergo-audit**](#ergo-audit) is a DAO for code auditing.
- [**ErgoNames**](#ergonames) is working on backend parts of their ErgoNames 
- [**SigmaBalls**](#sigmaballs) options trading
- [**MineErgo**](#mineergo) rewards miners with NFTs
- [**Sigma-Rust-Jit**](#sigma-rust-jit) is enhancing sigma-rust with JITC. 
...
A UI and website for generating 1010s art pieces so the community will be able to make their own. [Time willing, this entry] will also experiment with SVG format (versus PNG) and enable minting the piece in a connected wallet.
...
To see all the final submissions, head to the [presentations drive](https://drive.google.com/drive/folders/12yBnyMjq0hdVhXGOlpp8X0bwcj_Wvbgh).
...
- Buy and sell NFTs, cancel sales
