...
The following python code shows slicing the extended hash, returning k indexes. In this example we are assuming *h* < 614,400, thus N = 2<sup>26</sup> (67,108,864).
