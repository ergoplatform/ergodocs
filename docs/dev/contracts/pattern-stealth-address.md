...
- [Stealth addresses (user-facing)](stealth-address.md)
- [Mixing/Privacy (related)](zerojoin.md)
- Foundation: [Sigma protocols](sigma.md), [Schnorr](schnorr.md)
- [Zero-knowledge overview](zkp.md)
