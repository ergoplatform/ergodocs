...
> **On Cardano**, you will send an “incomplete” transaction, offering to pay the fee using a x amount of tokens and wait until a third part accepts your tokens in exchange for ADA to pay the fees.
> 
> **On Ergo**, we have pre-defined Babel Fee pools, so no waiting and we can know in advance what tokens we can use to pay fees and what’s the best price available.
