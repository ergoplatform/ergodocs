...
The mining protocol allocated a portion of the rewards to a treasury, managed by the non-profit Ergo Foundation, to bootstrap development and adoption. In its first 2.5 years, the Foundation accumulated 4,330,791.5 ERGs (4.43% of the total supply). For more information, visit the [Ergo Foundation](ergo-foundation.md), [Treasury](ef-treasury.md), [Votes](ef-votes.md), and [emission](emission.md) sections.
