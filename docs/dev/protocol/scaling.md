...
**Stateless Clients:** Then light clients: You can have full-node guarantees in Ergo without storing the full *UTXO set*. This should bring much-improved bootstrapping and block validation times and make it possible to raise TPS without compromising classic blockchain assumptions and guarantees. 
