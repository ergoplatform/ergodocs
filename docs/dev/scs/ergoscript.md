...
[You can make some simple apps](https://www.youtube.com/watch?v=d6Mf-oxaLIc) with just the node and ErgoScript using the `P2S` address compiler available at [wallet.plutomonkey.com/p2s](https://wallet.plutomonkey.com/p2s/). A transaction to this P2S or *pay-to-script* address will create an output locked with the script
